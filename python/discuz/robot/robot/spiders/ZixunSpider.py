...
class ZixunSpider(CrawlSpider):
    ...
    start_urls = ['http://www.echang.cn/house/index.asp','http://www.echang.cn/2shou/?page=1','http://www.echang.cn/job/qy.asp?gw=&lx=&sj=365&gz=&xl=&key=&page=1','http://news.163.com/','http://bj.house.163.com/']
    ...
    def parse_163_news(self, response):
        ...
        if title:
            ...
            d3 = d1 + datetime.timedelta(hours = random.randint(-1, 0))
